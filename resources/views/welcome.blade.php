...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">TaskLoan</a>
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="feature-item">
                    ...
                    <p class="text-muted">Putting potential in people needing financial help.</p>
                  </div>
                </div>
              </div>
              <div class="row">
            ...
            <div class="device-container">
              <div class="device-mockup iphone6_plus portrait white">
                <div class="device">
                  <div class="screen">
                    <!-- Demo image for screen mockup, you can put an image here, some HTML, an animation, video, or anything else! -->
                    <img src="img/Main.png" class="img-fluid" alt="">
                  </div>
                  <div class="button">
                    <!-- You can hook the "home button" to some JavaScript events or just remove it -->
                  </div>
    ...
    <section class="contact bg-primary text-white" id="contact">
      <div class="container">
        <h2>We
          ...
          new friends!</h2>
          <h6>Send us a ping at hello@justbecause.io</h6>
      </div>
    </section>
